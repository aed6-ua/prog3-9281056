...
public class FighterPreTest {
	...
	public final void testSetPositionNull() {
		...
		assertSame ("Asociación",null, fighter.getPosition());
	}
	...
	public final void testToString2() {
		 ...
		 */
		fighter.setPosition(new Coordinate(1,3));
		fighter.addAttack(15);
		fighter.addShield(-10);
		fighter.addVelocity(1000);
		final String sout = "(XWing 1 REBEL [1,3] {1100,95,70})";
		assertEquals(sout, fighter.toString());
